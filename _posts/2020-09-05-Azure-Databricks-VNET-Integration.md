...
-   Can’t use the same subnet by two workspaces
-----------------------------------------------
...
No, you can use subnets that has NICs already attached to them.
...
![enter image description here](/assets/images/posts/2020/assymetric-network.png)
